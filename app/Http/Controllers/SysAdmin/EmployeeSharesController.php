...
class EmployeeSharesController extends Controller
{
    ...
    public function egetDatatableEmployees(Request $request) {
        ...
        if($request->ajax()){
            ...
            $edemoWhere = $this->baseFilteredWhere($request, $elevel0, $elevel1, $elevel2, $elevel3, $elevel4);
    ...
    public function manageindex(Request $request)
    {
        ...
        return view('sysadmin.employeeshares.manageindex', compact ('request', 'criteriaList'));
    }
