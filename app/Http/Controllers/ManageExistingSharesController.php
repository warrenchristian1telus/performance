...
class ManageExistingSharesController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('sysadmin.shared.manageexistingshares', compact ('request', 'criteriaList'));
    }
    ...
    public function getList(Request $request)
    {
        if ($request->ajax()) 
        {
            ...
            // $query = User::leftjoin('employee_demo', 'users.guid', '=', 'employee_demo.guid')
            $query = User::withoutGlobalScopes()
            ->join('shared_profiles', 'users.id', '=', 'shared_profiles.shared_id')
