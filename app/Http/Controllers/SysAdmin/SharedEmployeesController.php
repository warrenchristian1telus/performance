...
class SharedEmployeesController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        return view('sysadmin.sharedemployees.index', compact('alert_format_list') );
    ...
    public function show(Request $request) 
    {
        ...
        if($request->ajax()){
            return view('sysadmin.sharedemployees.partials.show', compact('notificationLog') ); 
        } 
    }
    ...
    public function notify(Request $request) 
    {
        ...
        return view('sysadmin.sharedemployees.notify', compact('alert_format_list', 'criteriaList','matched_emp_ids', 'old_selected_emp_ids') );
    ...
    public function loadOrganizationTree(Request $request) {
        ...
        if($request->ajax()){
            return view('sysadmin.sharedemployees.partials.recipient-tree', compact('orgs','countByOrg','empIdsByOrgId') );
        } 
    ...
    public function send(Request $request) 
    {
        ...
        if ($validator->fails()) {
            ...
            //return redirect()->to( route('sysadmin.sharedemployees.notify') )->withErrors($validator)->withInput();
          }
        ...
        if ($response->getStatus() == 202) {
            return redirect()->route('sysadmin.sharedemployees.notify')
    ...
    public function getEmployees(Request $request,  $id) {
        ...
        // if($request->ajax()){
            return view('sysadmin.sharedemployees.partials.employee', compact('parent_id', 'employees') ); 
        // } 
    }
