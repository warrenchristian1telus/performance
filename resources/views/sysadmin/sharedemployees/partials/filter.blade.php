            ...
            <div class="form-group col-md-12">
              <span class="float-right">  
               <button type="submit" class="btn btn-primary" name="btn_search" 
                    value="btn_search" formaction="{{ route('sysadmin.sharedemployees.search') }}">Search</button>
...
@push('js')
    ...
    $('#dd_level0').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/sharedemployees/org-organizations'
            , dataType: 'json'
            , delay: 250
    ...
    $('#dd_level1').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/sharedemployees/org-programs' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
    ...
    $('#dd_level2').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/sharedemployees/org-divisions' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
    ...
    $('#dd_level3').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/sharedemployees/org-branches' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
    ...
    $('#dd_level4').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/sharedemployees/org-level4' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
    ...
    $('#job_titles').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/sharedemployees/job-titles' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
