        ...
        <div class="card">
            ...
            <div class="card-header" id="heading-{{ $eorg->id }}">
                ...
                <a role="button" data-toggle="collapse" href="#ecollapse-{{ $eorg->id }}" aria-expanded="false" class="collapsed"
                            aria-controls="collapse-{{ $eorg->id }}">
            ...
            <div id="ecollapse-{{ $eorg->id }}" class="collapse" data-parent="#eaccordion-level0" aria-labelledby="heading-{{ $eorg->id }}">
                <div class="card-body">
                    ...
                    <div id="eaccordion-1">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" id="heading-{{ $eprogram->id }}">
                                <h6 class="mb-0">
                                    ...
                                    <div id="eaccordion-2">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header" id="eheading-{{ $edivision->id }}">
                                                <h6 class="mb-0">
                                                <a role="button" data-toggle="ecollapse" href="#ecollapse-{{ $edivision->id }}" aria-expanded="false" class="collapsed"
                                                        ...
                                                        <div class="card">
                                                            @if ($ebranch->children->count() > 0 )    
                                                                <div class="card-header" id="eheading-{{ $ebranch->id }}">
                                                                    <h6 class="mb-0">
                                                                    <a role="button" data-toggle="ecollapse" href="#ecollapse-{{ $ebranch->id }}" aria-expanded="false" class="collapsed"
                                                                            ...
                                                                            @foreach($ebranch->children as $elevel4)
                                                                                <div class="card" style="margin-bottom: 0 !important;">
                                                                                    <div class="card-header employees" id="eheading-{{ $elevel4->id }}">
                                                                                        <h6 class="mb-0">
                                                                                            <a role="button" data-toggle="ecollapse" href="#ecollapse-{{ $elevel4->id }}" aria-expanded="false" class="collapsed"
...
$(document).ready(function() {
    ...
    // function load_employees_on_node2( tree_id ) {
    ...
    //     eload_employees_on_node(tree_id);
    // });
