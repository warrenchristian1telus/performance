<x-side-layout title="{{ __('Dashboard') }}">
	...
	<small><a href=" {{ route('sysadmin.employeeshare.manageindex') }}" class="btn btn-md btn-primary"><i class="fa fa-arrow-left"></i> Back to Manage Existing Employee Shares</a></small>
	...
	<form id="notify-form" action="{{ route('sysadmin.employeeshare.updategoal') }}" method="post">
		@csrf
