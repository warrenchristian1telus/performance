...
@push('js')
    ...
    $('#edd_level0').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/excuseemployees/eorg-organizations'
            , dataType: 'json'
            , delay: 250
    ...
    $('#edd_level1').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/excuseemployees/eorg-programs' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
    ...
    $('#edd_level2').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/excuseemployees/eorg-divisions' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
    ...
    $('#edd_level3').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/excuseemployees/eorg-branches' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
    ...
    $('#edd_level4').select2({
        ...
        allowClear: true,
        ajax: {
            url: '/sysadmin/excuseemployees/eorg-level4' 
            , dataType: 'json'
            , delay: 250
            , data: function(params) {
                var query = {
