...
class ExcusedEmployeesController extends Controller
{
    //
    public function index(Request $request) {
        ...
        return view('sysadmin.excusedemployees.index', compact('alert_format_list') );
    ...
    public function show(Request $request) 
    {
        ...
        if($request->ajax()){
            return view('sysadmin.excusedemployees.partials.show', compact('notificationLog') ); 
        } 
    }
    ...
    public function notify(Request $request) 
    {
        ...
        return view('sysadmin.excusedemployees.notify', compact('alert_format_list', 'criteriaList','matched_emp_ids', 'old_selected_emp_ids') );
    ...
    public function loadOrganizationTree(Request $request) {
        ...
        if($request->ajax()){
            return view('sysadmin.excusedemployees.partials.recipient-tree', compact('orgs','countByOrg','empIdsByOrgId') );
        } 
    ...
    public function send(Request $request) 
    {
        ...
        if ($validator->fails()) {
            ...
            //return redirect()->to( route('sysadmin.excusedemployees.notify') )->withErrors($validator)->withInput();
          }
        ...
        if ($response->getStatus() == 202) {
            return redirect()->route('sysadmin.excusedemployees.notify')
    ...
    public function getEmployees(Request $request,  $id) {
        ...
        // if($request->ajax()){
            return view('sysadmin.excusedemployees.partials.employee', compact('parent_id', 'employees') ); 
        // } 
    }
