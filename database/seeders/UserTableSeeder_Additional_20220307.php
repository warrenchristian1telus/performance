...
class UserTableSeeder_Additional_20220307 extends Seeder
{
  ...
  public function run()
  {
    ...
    $users = [
        ...
        [ 'id' => 120064, 'email' => 'melody.shepherd@gov.bc.ca', 'name' => 'Melody Shepherd', 'password' => 'melody@123', 'reporting_to' => 120081,  'role' => 'Supervisor', 'joining_date' => '01-MAR-2022' ],
        [ 'id' => 120065, 'email' => 'emilio.magliocchi@gov.bc.ca', 'name' => 'Emilio Magliocchi', 'password' => 'emilio@123', 'reporting_to' => 120081,  'role' => 'Supervisor', 'joining_date' => '01-MAR-2022' ],
        [ 'id' => 120066, 'email' => 'joe.gosse@gov.bc.ca', 'name' => 'Joe Gosse', 'password' => 'joe@123', 'reporting_to' => 120081,  'role' => 'Supervisor', 'joining_date' => '01-MAR-2022' ],
        ...
        [ 'id' => 120075, 'email' => 'sherry.froehlich@gov.bc.ca', 'name' => 'Sherry Froehlich', 'password' => 'sherry@123', 'reporting_to' => 120081,  'role' => 'Supervisor', 'joining_date' => '01-MAR-2022' ],
