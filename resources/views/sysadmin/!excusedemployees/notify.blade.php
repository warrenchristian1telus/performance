...
<div class="card">
 ...
 <form id="notify-form" action="{{ route('sysadmin.excusedemployees.send') }}" method="post">
	@csrf
...
@include('sysadmin.excusedemployees.partials.filter')
...
<nav>
  ...
  <div class="tab-content" id="nav-tabContent">
	<div class="tab-pane fade show active" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab">
		@include('sysadmin.excusedemployees.partials.recipient-list')
	</div>
  ...
  <br><h6 class="text-bold">Step 2. Enter date range and reason for excusing selected employees</h6> <br>
...
<br><h6 class="text-bold">Step 3. Declaration</h6><br>
<div class="card">
	<div class="card-body">
...
<br><h6 class="text-bold">Step 4. Excuse selected employees</h6><br>
<div class="col-md-3 mb-2">
 	<button class="btn btn-primary mt-2" type="button" 
		onclick="confirmSendNotifyModal()"
		name="btn_send" value="btn_send">Excuse Employees</button>
...
<x-slot name="js">
	...
	$(document).ready(function(){
		...
		$("#nav-tree-tab").on("click", function(e) {
			...
			if($.trim($(target).attr('loaded'))=='') {
				...
				$.when( 
						$.ajax({
							url: '/sysadmin/excusedemployees/org-tree',
							type: 'GET',
    ...
    //             width: '100%',
    //             ajax: {
    //                 url: '{{ route('sysadmin.excusedemployees.users.list') }}', // '/users', 
    //                 dataType: 'json',
