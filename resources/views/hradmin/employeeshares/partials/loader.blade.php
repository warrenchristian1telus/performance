...
@push('js')
    ...
    <script>
        $('#dd_level0').select2({
            ...
            allowClear: true,
            ajax: {
                url: '/hradmin/employeeshares/org-organizations'
                , dataType: 'json'
                , delay: 250
        ...
        $('#dd_level1').select2({
            ...
            allowClear: true,
            ajax: {
                url: '/hradmin/employeeshares/org-programs' 
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
        ...
        $('#dd_level2').select2({
            ...
            allowClear: true,
            ajax: {
                url: '/hradmin/employeeshares/org-divisions' 
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
        ...
        $('#dd_level3').select2({
            ...
            allowClear: true,
            ajax: {
                url: '/hradmin/employeeshares/org-branches' 
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
        ...
        $('#dd_level4').select2({
            ...
            allowClear: true,
            ajax: {
                url: '/hradmin/employeeshares/org-level4' 
                , dataType: 'json'
                , delay: 250
                , data: function(params) {
                    var query = {
